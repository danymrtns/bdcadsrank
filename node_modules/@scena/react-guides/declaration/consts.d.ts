...
export declare const METHODS: readonly ["getGuides", "loadGuides", "scroll", "scrollGuides", "resize"];
export declare const EVENTS: readonly ["changeGuides", "dragStart", "drag", "dragEnd"];
